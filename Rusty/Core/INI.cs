...
namespace IronAHK.Rusty
{
    partial class Core
    {
        ...
        public static void IniDelete(string Filename, string Section, string Key)
        {
            ...
            error = Windows.Misc.WritePrivateProfileString(Section, Key.Length == 0 ? null : Key, null, Filename) ? 0 : 1;
        }
        ...
        public static void IniRead(out string OutputVar, string Filename, string Section, string Key, string Default)
        {
            ...
            Windows.Misc.GetPrivateProfileString(Section, Key, Default, buf, (uint)buf.Capacity, Filename);
        ...
        public static void IniWrite(string Value, string Filename, string Section, string Key)
        {
            ...
            error = Windows.Misc.WritePrivateProfileString(Section, Key, Value, Filename) ? 0 : 1;
        }
    }
}
